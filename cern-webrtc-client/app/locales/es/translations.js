...
export default {
  ...
  'join-meeting': {
    ...
    'button': {
      ...
      'set_random_name_button': 'Aleatorio'
    }
  },
  ...
  'meeting-box': {
    ...
    'unmute_mic': 'Desactivar micrófono',
    'mute_speakers': 'Silenciar altavoces',
    ...
    'stop_sharing': 'Dejar de compartir pantalla',
    'start_sharing': 'Compartir pantalla',
    'available_shares': 'PANTALLAS DISPONIBLES',
    ...
    'share_modal': {
      ...
      'download_chrome_extension': 'Download the CERN Vidyo Chrome extension',
      'download_firefox_extension': 'Download the CERN Vidyo Firefox extension',
      'chrome_extension_step1': 'Go to Chrome Settings/Preferences -> Extensions',
      'chrome_extension_step2': 'Select Developer mode checkbox.',
      'chrome_extension_step3': 'Drag & drop the downloaded .crx file to the Chrome extensions page.',
    ...
    'help-modal': {
      ...
      'enable_microphone': 'Activa o desactiva el micrófono',
      'enable_webcam': 'Activa o desactiva la webcam',
      'share': 'Share screen (Chrome and Firefox only. Requires CERN Vidyo extension)',
      'description': 'Descripción',
      'disabled_icon': 'Icono desactivado',
      'enabled_icon': 'Icono activado'
    },
    'field': {
      'chat_message_placeholder': 'Escribe tu mensaje aquí...',
    },
